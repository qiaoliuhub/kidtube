...
class LinkCollector(object):
    ...
    def __persist_data(self, res, cur_page_token):
        ...
        persist_folder = os.path.join(CUR_FILE_DIR, '../Data', 'collected_link_json', 'collected_link_json_' + self.folder_name_key_word)
    ...
    def get_persisted_data_dir(self):
        ...
        :return: str
        '''
        return os.path.join(CUR_FILE_DIR, '../Data', 'collected_link_json', 'collected_link_json_' + self.folder_name_key_word)
...
class VideoDetailsCollector(object):
    ...
    def __persist_data(self, res, unique_identifier):
        ...
        if unique_identifier is None:
            unique_identifier = ''
        persisted_data_dir = os.path.join(CUR_FILE_DIR, '../Data', 'collected_video_detail', 'collected_video_detail_' + self.dir_name_key_word)
    ...
    def get_persisted_data_directory(self):
        return os.path.join(CUR_FILE_DIR, '../Data', 'collected_video_detail', 'collected_video_detail_' + self.dir_name_key_word)
...
if __name__ == '__main__':
    ...
    print(len(res_df))
    res_df.to_csv(os.path.join(CUR_FILE_DIR, '../Data', csv_result_dir, 'video_details_' + folder_name_key_words +'.csv'))
